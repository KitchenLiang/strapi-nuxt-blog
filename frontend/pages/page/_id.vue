    ...
    <div class="main-content">
      <div class="container">
        ...
        <div class="article-list-wrap">
          ...
          <article-list :articleList="articles" :pageSize="pagesize" :total="articleCount" :currentPage="$route.params.id" @fatherMethod="changePagination"></article-list>
        </div>
        <!-- article list end -->
      </div>
  ...
  export default {
    ...
    apollo: {
      articles: {
        ...
        query: articlesQuery,
        variables () {
          return { limit: this.pagesize,start:(this.$nuxt.$route.params.id-1)*10,sort: "created_at:desc" }
        }
      },
    }
  }
